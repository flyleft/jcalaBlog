$(function() {
    function a(a) {
        $.getJSON("/admin/pro.json?id=" + a, function(a) {
            bootbox.dialog({
                ...
                buttons: {
                    success: {
                        ...
                        callback: function() {
                            ...
                            a.action = "/admin/updPro.action", a.method = "post", a.submit()
                        }
                    }
                }
            })
    ...
    $("#info_update").bind("click", function() {
        ...
        a.action = "/admin/info.action", a.method = "post", a.submit()
        ...
        a.action = "/login.action", b = document.loginForm.passBefore.value, document.loginForm.password.value = md5(b), a.method = "post", a.submit()
        ...
        bootbox.dialog({
            ...
            buttons: {
                success: {
                    ...
                    callback: function() {
                        var a = document.getElementById("add_pro_form");
                        a.action = "/admin/addPro.action", a.method = "post", a.submit()
                    }
                }
            }
        })
